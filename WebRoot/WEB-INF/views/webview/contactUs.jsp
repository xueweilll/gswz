...
<body>
	...
	<div class="news-center">
		<div class="news-left">
			...
			<span style="position:absolute; top:30px; left:50px; color:#fff; font-size:23px">联系我们</span>
			<p style="position:absolute; top:45px; left:50px; color:#fff; font-size:16px">Contact Us</p>
			</a>
		</div>
		<div class="news-right news-rightlist">
			<a class="news-left-title"> <span><img
					src="img/shuxian.jpg" /> <i class="current-position">首页>联系我们</i> </span>
			</a>
