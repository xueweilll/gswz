...
public class ProductController extends BasicController {
	...
	public ModelAndView index(HttpServletRequest request) {
		// 0：公司新闻 1：解决方案 2：产品中心-制造业 3：合作伙伴 4：关于我们 5：常用链接 6：人才招聘 7：联系我们 8：产品中心-政府行业 9:产品中心-MES系统
		String manufacturingContent = null;
		String governmentalContent = null;
		String messystemContent = null;
		try {
			manufacturingContent = service.selectByClasses(2);
			governmentalContent = service.selectByClasses(8);
			messystemContent = service.selectByClasses(9);
		} catch (Exception e) {
			e.printStackTrace();
		...
		mv.addObject("messystemContent", messystemContent);
